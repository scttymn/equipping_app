...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference("Family.count") do
      post families_url, params: { family: { address_id: @family.address_id, name: @family.name } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { address_id: @family.address_id, name: @family.name } }
