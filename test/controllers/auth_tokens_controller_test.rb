...
class AuthTokensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auth_token" do
    assert_difference("AuthToken.count") do
      post auth_tokens_url, params: { auth_token: { expires_at: @auth_token.expires_at, person_id: @auth_token.person_id, token: @auth_token.token } }
    end
  ...
  test "should update auth_token" do
    patch auth_token_url(@auth_token), params: { auth_token: { expires_at: @auth_token.expires_at, person_id: @auth_token.person_id, token: @auth_token.token } }
