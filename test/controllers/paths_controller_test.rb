...
class PathsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create path" do
    assert_difference("Path.count") do
      post paths_url, params: { path: { created_by_id: @path.created_by_id, created_by_type: @path.created_by_type, description: @path.description, name: @path.name } }
    end
  ...
  test "should update path" do
    patch path_url(@path), params: { path: { created_by_id: @path.created_by_id, created_by_type: @path.created_by_type, description: @path.description, name: @path.name } }
