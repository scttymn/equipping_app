...
class FamilyMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family_member" do
    assert_difference("FamilyMember.count") do
      post family_members_url, params: { family_member: { family_id: @family_member.family_id, is_parent: @family_member.is_parent, person_id: @family_member.person_id } }
    end
  ...
  test "should update family_member" do
    patch family_member_url(@family_member), params: { family_member: { family_id: @family_member.family_id, is_parent: @family_member.is_parent, person_id: @family_member.person_id } }
